Feature: Agregar producto al carrito
  ...
  Scenario: Agregar un producto disponible al carrito vacio
    When el cliente 1 agrega el producto 10 con cantidad 1 a su carrito
    Then la respuesta debe tener codigo 201
    And el carrito del cliente 1 debe contener el producto 10 con cantidad 1
    And el total del carrito del cliente 1 debe ser 50000

  Scenario: Agregar el mismo producto dos veces incrementa la cantidad
    Given el cliente 1 ya tiene el producto 10 con cantidad 1 en su carrito
    When el cliente 1 agrega el producto 10 con cantidad 2 a su carrito
    Then la respuesta debe tener codigo 200
    And el carrito del cliente 1 debe contener el producto 10 con cantidad 3
    And el total del carrito del cliente 1 debe ser 150000

  Scenario: No se puede agregar un producto inexistente
    When el cliente 1 agrega el producto 999 con cantidad 1 a su carrito
  ...
  Scenario: No se puede agregar mas cantidad que el stock disponible
    When el cliente 1 agrega el producto 10 con cantidad 99 a su carrito
  ...
  Scenario: No se puede agregar una cantidad invalida
    When el cliente 1 agrega el producto 10 con cantidad 0 a su carrito
    Then la respuesta debe tener codigo 422
